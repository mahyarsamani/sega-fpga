...
# Set xvlog options
xvlog_opts="--incr --relax -L axi_vip_v1_1_12 -L hbm_v1_0_12 -L axi4stream_vip_v1_1_12 -L xilinx_vip"
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb LoadVerticesFIFO.wdb xsim.dir)
