...
void XRtl_kernel_wizard_0_Set_Message(XRtl_kernel_wizard_0 *InstancePtr, u64 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XRtl_kernel_wizard_0_WriteReg(InstancePtr->Control_BaseAddress, XRTL_KERNEL_WIZARD_0_CONTROL_ADDR_MESSAGE_DATA, (u32)(Data));
    XRtl_kernel_wizard_0_WriteReg(InstancePtr->Control_BaseAddress, XRTL_KERNEL_WIZARD_0_CONTROL_ADDR_MESSAGE_DATA + 4, (u32)(Data >> 32));
}

u64 XRtl_kernel_wizard_0_Get_Message(XRtl_kernel_wizard_0 *InstancePtr) {
    u64 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XRtl_kernel_wizard_0_ReadReg(InstancePtr->Control_BaseAddress, XRTL_KERNEL_WIZARD_0_CONTROL_ADDR_MESSAGE_DATA);
    Data += (u64)XRtl_kernel_wizard_0_ReadReg(InstancePtr->Control_BaseAddress, XRTL_KERNEL_WIZARD_0_CONTROL_ADDR_MESSAGE_DATA + 4) << 32;
    return Data;
}

void XRtl_kernel_wizard_0_Set_PEControl(XRtl_kernel_wizard_0 *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XRtl_kernel_wizard_0_WriteReg(InstancePtr->Control_BaseAddress, XRTL_KERNEL_WIZARD_0_CONTROL_ADDR_PECONTROL_DATA, Data);
}

u32 XRtl_kernel_wizard_0_Get_PEControl(XRtl_kernel_wizard_0 *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XRtl_kernel_wizard_0_ReadReg(InstancePtr->Control_BaseAddress, XRTL_KERNEL_WIZARD_0_CONTROL_ADDR_PECONTROL_DATA);
    return Data;
}
