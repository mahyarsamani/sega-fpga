...
proc edit_core {core} {
  ::ipx::associate_bus_interfaces -busif "LoadVertices" -clock "ap_clk" $core
  set axis_bif      [::ipx::get_bus_interfaces -of $core  "LoadVertices"] 
  ...
  set_property value        1   $bifparam
  set_property value_source constant     $bifparam
  ::ipx::associate_bus_interfaces -busif "LoadEdges" -clock "ap_clk" $core
  set axis_bif      [::ipx::get_bus_interfaces -of $core  "LoadEdges"] 
  set bifparam [::ipx::add_bus_parameter -quiet "TDATA_NUM_BYTES" $axis_bif]
  ...
  set_property value        1   $bifparam
  set_property value_source constant     $bifparam
  ::ipx::associate_bus_interfaces -busif "Results" -clock "ap_clk" $core
  set axis_bif      [::ipx::get_bus_interfaces -of $core  "Results"] 
  set bifparam [::ipx::add_bus_parameter -quiet "TDATA_NUM_BYTES" $axis_bif]
  set_property value        32   $bifparam
  set_property value_source constant     $bifparam
  set bifparam [::ipx::add_bus_parameter -quiet "TUSER_WIDTH" $axis_bif]
  ...
  set reg      [::ipx::add_register -quiet "GPNControl" $addr_block]
  set_property address_offset 0x010 $reg
  set_property size           [expr {4*8}]   $reg

  set reg      [::ipx::add_register -quiet "FirstMessage" $addr_block]
  set_property address_offset 0x018 $reg
  set_property size           [expr {8*8}]   $reg

  set reg      [::ipx::add_register -quiet "MemoryOffset0" $addr_block]
  set_property address_offset 0x024 $reg
  set_property size           [expr {4*8}]   $reg

  set reg      [::ipx::add_register -quiet "MemoryOffset1" $addr_block]
  set_property address_offset 0x02c $reg
  set_property size           [expr {4*8}]   $reg

  set reg      [::ipx::add_register -quiet "MemoryOffset2" $addr_block]
  set_property address_offset 0x034 $reg
  set_property size           [expr {4*8}]   $reg

  set reg      [::ipx::add_register -quiet "MemoryOffset3" $addr_block]
  set_property address_offset 0x03c $reg
  set_property size           [expr {4*8}]   $reg

  set reg      [::ipx::add_register -quiet "MemoryOffset4" $addr_block]
  set_property address_offset 0x044 $reg
  set_property size           [expr {4*8}]   $reg

  set reg      [::ipx::add_register -quiet "MemoryOffset5" $addr_block]
  set_property address_offset 0x04c $reg
  set_property size           [expr {4*8}]   $reg

  set reg      [::ipx::add_register -quiet "MemoryOffset6" $addr_block]
  set_property address_offset 0x054 $reg
  set_property size           [expr {4*8}]   $reg

  set reg      [::ipx::add_register -quiet "MemoryOffset7" $addr_block]
  set_property address_offset 0x05c $reg
  set_property size           [expr {4*8}]   $reg

  set reg      [::ipx::add_register -quiet "MemoryOffset8" $addr_block]
  set_property address_offset 0x064 $reg
  set_property size           [expr {4*8}]   $reg

  set reg      [::ipx::add_register -quiet "MemoryOffset9" $addr_block]
  set_property address_offset 0x06c $reg
  set_property size           [expr {4*8}]   $reg

  set reg      [::ipx::add_register -quiet "MemoryOffset10" $addr_block]
  set_property address_offset 0x074 $reg
  set_property size           [expr {4*8}]   $reg

  set reg      [::ipx::add_register -quiet "MemoryOffset11" $addr_block]
  set_property address_offset 0x07c $reg
  set_property size           [expr {4*8}]   $reg

  set reg      [::ipx::add_register -quiet "MemoryOffset12" $addr_block]
  set_property address_offset 0x084 $reg
  set_property size           [expr {4*8}]   $reg

  set reg      [::ipx::add_register -quiet "MemoryOffset13" $addr_block]
  set_property address_offset 0x08c $reg
  set_property size           [expr {4*8}]   $reg

  set reg      [::ipx::add_register -quiet "MemoryOffset14" $addr_block]
  set_property address_offset 0x094 $reg
  set_property size           [expr {4*8}]   $reg

  set reg      [::ipx::add_register -quiet "MemoryOffset15" $addr_block]
  set_property address_offset 0x09c $reg
  set_property size           [expr {4*8}]   $reg

  set reg      [::ipx::add_register -quiet "MemoryOffset16" $addr_block]
  set_property address_offset 0x0a4 $reg
  set_property size           [expr {4*8}]   $reg

  set reg      [::ipx::add_register -quiet "TotalEdgeSize" $addr_block]
...
proc package_project {path_to_packaged kernel_vendor kernel_library kernel_name} {
  ...
  foreach user_parameter [list C_S_AXI_CONTROL_ADDR_WIDTH C_S_AXI_CONTROL_DATA_WIDTH C_LOADVERTICES_TDATA_WIDTH C_LOADEDGES_TDATA_WIDTH C_RESULTS_TDATA_WIDTH] {
