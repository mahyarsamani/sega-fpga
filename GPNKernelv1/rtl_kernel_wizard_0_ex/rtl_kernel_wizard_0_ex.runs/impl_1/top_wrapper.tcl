...
namespace eval ::optrace {
  variable script "/home/austin01/vivado/rtl_kernel_wizard_0_ex/rtl_kernel_wizard_0_ex.runs/impl_1/top_wrapper.tcl"
...
set rc [catch {
  ...
  open_checkpoint /home/austin01/vivado/rtl_kernel_wizard_0_ex/rtl_kernel_wizard_0_ex.runs/impl_1/top_wrapper.dcp
...
OPTRACE "Route Design: post hook" START { }
  set src_rc [catch { 
    puts "source /home/austin01/vivado/rtl_kernel_wizard_0_ex/imports/post_synth_impl.tcl"
  ...
  if {$src_rc} { 
    ...
    if { $tool_flow eq {SDx} } { 
      ...
      send_gid_msg -id 3 -ssname VPL_TCL -severity ERROR "sourcing script /home/austin01/vivado/rtl_kernel_wizard_0_ex/imports/post_synth_impl.tcl failed"
    } else {
      send_msg_id runtcl-1 status "$_RESULT"
      send_msg_id runtcl-2 status "sourcing script /home/austin01/vivado/rtl_kernel_wizard_0_ex/imports/post_synth_impl.tcl failed"
    }
    return -code error
  }
