...
int main(int argc, char** argv)
{
    ...
    err = 0;
    cl_ulong d_Message = 0;
    err |= clSetKernelArg(kernel, 0, sizeof(cl_ulong), &d_Message); // Not used in example RTL logic.
    cl_uint d_PEControl = 0;
    err |= clSetKernelArg(kernel, 1, sizeof(cl_uint), &d_PEControl); // Not used in example RTL logic.
